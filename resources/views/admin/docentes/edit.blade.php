            ...
            <form action="{{ route('admin.docentes.update', $docente->id_docente) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="mb-4">
                        ...
                        <input name="rfc" value="{{ old('rfc', $docente->rfc) }}"
                               class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition duration-300" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 dark:text-gray-300 font-medium mb-2">Nombre Completo</label>
                        <input name="nombre" value="{{ old('nombre', $docente->nombre) }}"
                               class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition duration-300" required>
                    </div>
                    <div class="mb-4">
